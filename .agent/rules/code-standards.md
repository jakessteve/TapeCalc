...
** QC Enforcement:** Follow the tiered verification model in `process-gates.md` §3. For Medium+ tasks, @qc MUST independently verify test coverage and quality. For Small tasks, @qc spot-checks. For Trivial tasks, @dev self-verification is sufficient.
