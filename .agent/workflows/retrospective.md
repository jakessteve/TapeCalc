...
2. **[SOT VERIFICATION]:** @sa verifies all SOT documents are in sync with delivered code (Rule `process-gates.md`):
...
4. **[IMPROVEMENT ANALYSIS]:** @pm reads the retrospective and identifies improvement opportunities:
...
5. **[BRAINSTORM & RESEARCH]:** For each identified improvement:
...
6. **[DRAFT CHANGES]:** For each approved improvement proposal:
...
7. **[APPLY WITH APPROVAL]:** Present ALL drafted changes to the User for approval:
