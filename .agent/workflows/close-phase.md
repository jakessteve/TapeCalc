...
7. **[RETROSPECTIVE]:** Trigger Workflow `/retrospective` for post-phase reflection and self-improvement analysis.
8. **[CONTEXT FLUSH]:** Force the system to run Rule `anti-patterns.md` (Clear Context).
